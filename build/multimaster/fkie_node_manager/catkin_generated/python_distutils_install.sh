...
echo_and_run cd "/home/apex-15/catkin_ws/src/multimaster/fkie_node_manager"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/apex-15/catkin_ws/src/multimaster/fkie_node_manager/setup.py" \
     \
    build --build-base "/home/apex-15/catkin_ws/build/multimaster/fkie_node_manager" \
    install \
    --root="${DESTDIR-/}" \
